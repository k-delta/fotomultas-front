...
jest.mock('../store/fineStore', () => ({
  useFineStore: () => ({
    ...
    fines: [
      { id: 'F1', plateNumber: 'A', evidenceCID: '', location: '', timestamp: new Date().toISOString(), infractionType: 'speeding', cost: 1000, ownerIdentifier: '', currentState: 0, statusHistory: [] },
      { id: 'F2', plateNumber: 'B', evidenceCID: '', location: '', timestamp: new Date().toISOString(), infractionType: 'red_light', cost: 2000, ownerIdentifier: '', currentState: 1, statusHistory: [] }
    ],
    activities: [
